...
import { Library } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type Library.
 ...
 */
export class LibraryBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "Library";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(
            this._node as Library,
            "Library-overall",
            "",
            [
                BoxFactory.horizontalLayout(
                    this._node as Library,
                    "Library-hlist-line-0",
                    "",
                    [
                        BoxUtil.labelBox(this._node as Library, "Library", "top-1-line-0-item-0"),
                        BoxUtil.textBox(this._node as Library, "name"),
                        BoxUtil.labelBox(this._node as Library, "\{", "top-1-line-0-item-2"),
                    ],
                    { selectable: false },
                ),
                BoxUtil.indentBox(
                    ...
                    BoxFactory.horizontalLayout(
                        this._node as Library,
                        "Library-hlist-line-1",
                        "",
                        [
                            BoxUtil.labelBox(this._node as Library, "procedures", "top-1-line-1-item-0"),
                            BoxUtil.getBoxOrAction(this._node as Library, "procedures", "Procedure", this.mainHandler),
                        ],
                        { selectable: false },
                    ),
                ),
                BoxUtil.labelBox(this._node as Library, "}", "top-1-line-2-item-0"),
            ],
            { cssClass: "Library" },
        );
    }
