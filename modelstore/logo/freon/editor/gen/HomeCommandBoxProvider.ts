...
import { HomeCommand } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type HomeCommand.
 ...
 */
export class HomeCommandBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "HomeCommand";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(
            this._node as HomeCommand,
            "HomeCommand-overall",
            "",
            [
                BoxFactory.horizontalLayout(
                    this._node as HomeCommand,
                    "HomeCommand-hlist-line-0",
                    "",
                    [
                        BoxUtil.labelBox(this._node as HomeCommand, "HomeCommand", "top-1-line-0-item-0"),
                        BoxUtil.textBox(this._node as HomeCommand, "name"),
                        BoxUtil.labelBox(this._node as HomeCommand, "\{", "top-1-line-0-item-2"),
                    ],
                    { selectable: false },
                ),
                BoxUtil.labelBox(this._node as HomeCommand, "}", "top-1-line-1-item-0"),
            ],
            { cssClass: "HomeCommand" },
        );
    }
}
