...
export class LogoTyperPart implements FreTyper {
    mainTyper!: FreCompositeTyper; //  Setting this property to an instance of LogoTyper is ensured by 'initializeTypers()'
