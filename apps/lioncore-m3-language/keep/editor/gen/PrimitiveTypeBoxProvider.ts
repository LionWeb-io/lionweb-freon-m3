...
/**
 * This class implements the box provider for a single node of type PrimitiveType.
...
export class PrimitiveTypeBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(
            this._node as PrimitiveType,
            "PrimitiveType-overall",
            "",
            [
                BoxFactory.horizontalLayout(
                    this._node as PrimitiveType,
                    "PrimitiveType-hlist-line-0",
                    "",
                    [
                        BoxUtil.labelBox(this._node as PrimitiveType, "PrimitiveType", "top-1-line-0-item-0"),
                        BoxUtil.textBox(this._node as PrimitiveType, "name"),
                        BoxUtil.labelBox(this._node as PrimitiveType, "\{", "top-1-line-0-item-2"),
                    ],
                    { selectable: false },
                ),
                BoxUtil.indentBox(
                    ...
                    BoxFactory.horizontalLayout(
                        this._node as PrimitiveType,
                        "PrimitiveType-hlist-line-1",
                        "",
                        [
                            BoxUtil.labelBox(this._node as PrimitiveType, "key", "top-1-line-1-item-0"),
                            BoxUtil.textBox(this._node as PrimitiveType, "key"),
                        ],
                        { selectable: false },
                    ),
                ),
                BoxUtil.labelBox(this._node as PrimitiveType, "}", "top-1-line-2-item-0"),
            ],
