...
export class ReferenceBoxProvider extends FreBoxProvider {
    ...
    getTextual() {
        return BoxFactory.horizontalLayout(this._node, "Reference-hlist-line-0", "", [
            BoxUtil.booleanBox(this._node, "optional", { yes: "optional", no: "mandatory", unknown: "undefined-undefined" }, BoolDisplay.SELECT),
            BoxUtil.labelBox(this._node, "reference", "top-1-line-0-item-1"),
...
//# sourceMappingURL=ReferenceBoxProvider.js.map