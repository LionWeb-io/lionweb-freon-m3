...
/**
 * Interface LionCore_M3Worker implements the extended visitor pattern of instances of language LionCore_M3.
 * Class LionCore_M3Walker implements the traversal of the model tree, classes that implement this interface
