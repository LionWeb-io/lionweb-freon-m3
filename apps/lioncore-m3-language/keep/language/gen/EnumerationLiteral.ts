...
/**
 * Class EnumerationLiteral is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class EnumerationLiteral extends MobxModelElementImpl implements FreNamedNode, IKeyed {
    /**
    ...
    readonly $typename: string = "EnumerationLiteral"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<EnumerationLiteral>): boolean {
