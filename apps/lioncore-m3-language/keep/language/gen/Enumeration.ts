...
/**
 * Class Enumeration is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class Enumeration extends DataType implements FreNode {
    /**
    ...
    readonly $typename: string = "Enumeration"; // holds the metatype in the form of a string
    ...
    literals!: EnumerationLiteral[]; // implementation of part 'literals'
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<Enumeration>): boolean {
