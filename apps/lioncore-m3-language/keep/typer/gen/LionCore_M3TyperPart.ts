...
export class LionCore_M3TyperPart implements FreTyper {
    mainTyper!: FreCompositeTyper; //  Setting this property to an instance of LionCore_M3Typer is ensured by 'initializeTypers()'
