...
import { LionCore_M3, Language, Annotation, Concept, Interface, Containment, DataType, Enumeration, EnumerationLiteral, Feature, Classifier, Link, LanguageEntity, PrimitiveType, Property, Reference } from "../../language/gen/index.js";
...
export declare class LionCore_M3NonOptionalsChecker extends LionCore_M3DefaultWorker implements LionCore_M3CheckerInterface {
    myWriter: FreWriter;
    errorList: FreError[];
...
//# sourceMappingURL=LionCore_M3NonOptionalsChecker.d.ts.map