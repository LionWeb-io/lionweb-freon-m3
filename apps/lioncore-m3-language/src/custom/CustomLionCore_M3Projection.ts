...
/**
 * Class CustomLionCore_M3Projection provides an entry point for the language engineer to
 ...
 */
export class CustomLionCore_M3Projection implements FreProjection {
    name: string = "Custom";
