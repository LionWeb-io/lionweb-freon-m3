...
/**
 * Class CustomLionCore_M3Actions provides an entry point for the language engineer to
 ...
 */
export class CustomLionCore_M3Actions implements FreCombinedActions {
