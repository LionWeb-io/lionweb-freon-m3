...
import { PrimitiveType } from "../language/index.js";
...
export class PrimitiveTypeBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            ...
            "",
            [
                BoxUtil.labelBox(this._node as PrimitiveType, "primitive", "top-1-line-0-item-0"),
                BoxUtil.textBox(this._node as PrimitiveType, "name"),
                BoxUtil.labelBox(this._node as PrimitiveType, ":", "top-1-line-0-item-2"),
                BoxUtil.textBox(this._node as PrimitiveType, "primitiveType"),
            ],
            { selectable: false },
        );
    }
