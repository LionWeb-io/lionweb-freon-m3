...
export class ProtocolTyperPart implements FreTyper {
    mainTyper!: FreCompositeTyper; //  Setting this property to an instance of ProtocolTyper is ensured by 'initializeTypers()'
